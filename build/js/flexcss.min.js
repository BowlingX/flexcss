...
"use strict";function i(e){return e&&e.__esModule?e:{"default":e}}function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var o="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e},a=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}();Object.defineProperty(t,"__esModule",{value:!0});var s=n(7),l=i(s),u=n(2),d=i(u),c=n(4),f=i(c),h="data-original-width",v="data-original-height",p="data-src",m="has-prev",g="has-next",y="loading",E="data-no-thumbnail",_="data-href",b="href",C=39,T=37,O="data-close-modal",w=function(){function t(e,n,i,o){r(this,t);var a=e instanceof HTMLElement?e:document.getElementById(e);this._modalAppend=i||e,this._resizeEvent=null,this._keyboardNextEvent=null,this._future=null,this._nextFuture=this._future,this._imageContainer=null,this._modalContainerDiv=null,this._contentContainer=null,this._closerContainerDiv=null,this._delegateContainer=a,this._attributeSelector=n,this._widget=null,this._isOpen=!1,this.target=null,this.img=null,this._isLoading=!1,this.options={registerPrevNextEvents:!0,closeOnLast:!0,onNext:function(){return!0},onClose:function(){},getNext:null,getPrev:null,onSwitchImage:function(){}},Object.assign(this.options,o)}return a(t,[{key:"findImmediateNextTarget",value:function(e){return e&&e.children[0].hasAttribute(this._attributeSelector)?e.children[0]:null}},{key:"getNext",value:function(e){return this.options.getNext?this.options.getNext.apply(this,[e]):this.findImmediateNextTarget(e.parentNode.nextElementSibling)}},{key:"getPrev",value:function(e){return this.options.getPrev?this.options.getPrev.apply(this,[e]):this.findImmediateNextTarget(e.parentNode.previousElementSibling)}},{key:"registerEvents",value:function(e){var t=this;this._delegateContainer.addEventListener(d["default"].getTabEvent(),function(n){var i=n.target,r=i.parentNode,o=i.hasAttribute(t._attributeSelector),a=r&&r.hasAttribute(t._attributeSelector);!o&&a&&(o=!0,i=r),o&&(n.preventDefault(),t.open(i).then(function(n){e&&e.apply(t,[n,i])}))})}},{key:"getContentContainer",value:function(){return this._contentContainer}},{key:"switchImageByDirection",value:function(e){var t=e?this.getPrev(this.target):this.getNext(this.target);return this.options.onNext.apply(this,[t])?this.switchImage(t):new Promise(function(e,n){return n(t)})}},{key:"isLoading",value:function(){return this._isLoading}},{key:"_runOptionalClose",value:function(){this.options.closeOnLast&&this.modal.close()}},{key:"_setupPrevNextStates",value:function(){var e=this.target,t=this.getPrev(e),n=this.getNext(e),i=m,r=g;t?this._imageContainer.classList.add(i):this._imageContainer.classList.remove(i),n?this._imageContainer.classList.add(r):this._imageContainer.classList.remove(r)}},{key:"_calculateContainer",value:function(e){var t=this;d["default"].isIE()&&setTimeout(function(){t._imageContainer.style.height=e.offsetHeight+"px"},0)}},{key:"switchImage",value:function(e){var n=this,i=this,r=this.img;return this._isLoading=!0,i._nextFuture=new Promise(function(a,s){if(i.options.onSwitchImage.apply(i,[i._nextFuture]),e){var l=function(){var o=e.hasAttribute(E)?e:e.children[0]||e,l=e.getAttribute(_)||e.getAttribute(b),u=o.getAttribute(p)||o.src||l,d=new Image;return u?(n.target=e,d.src=u,i._imageContainer.classList.add(y),void d.addEventListener("load",function(){r.src=u,i._imageContainer.style.backgroundImage="url("+u+")",t._setupMaxWidthHeight(e,r,d),i._calculateContainer(r),i.highRes(o,l),i._setupPrevNextStates(),i._imageContainer.classList.remove(y),n._isLoading=!1,a(u,n.target)})):(s(e),{v:void 0})}();if("object"===("undefined"==typeof l?"undefined":o(l)))return l.v}else s(n)}),i._nextFuture}},{key:"highRes",value:function(e,t){var n=this;if(t&&e.src!==t){var i=new Image;i.src=t,i.addEventListener("load",function(){n._getSrc(e)===n.img.src&&(n.img.src=t,n._imageContainer.style.backgroundImage="url("+t+")")})}}},{key:"_getSrc",value:function(e){return e.getAttribute(p)||e.src}},{key:"open",value:function(n){var i=this,r=this;return n?(this.target=n,this._isOpen&&n?this.switchImage(n).then(function(){return i}):(this._isOpen=!0,this._widget=(new f["default"]).setAsync(function(){var o=n.hasAttribute(E)?n:n.children[0]||n,a=n.getAttribute(_)||n.getAttribute(b),l=i._getSrc(o)||a,u=new Image;return u.src=l,i._imageContainer=document.createElement("div"),i._modalContainerDiv=document.createElement("div"),i._closerContainerDiv=document.createElement("i"),i._contentContainer=document.createElement("div"),i._closerContainerDiv.className="modal-close modal-close-lightbox icon-cancel-1",i._closerContainerDiv.setAttribute(O,O),i._modalContainerDiv.className="modal image-modal",i._modalContainerDiv.appendChild(i._imageContainer),i._modalContainerDiv.appendChild(i._contentContainer),i._modalContainerDiv.appendChild(i._closerContainerDiv),i._contentContainer.className="content-container",i._isLoading=!0,i._future=new Promise(function(s){u.addEventListener("load",function(){i._imageContainer.className="image-container";var c=document.createElement("img");i.img=c,c.src=l,t._setupMaxWidthHeight(n,c,u),i._imageContainer.appendChild(c),i._imageContainer.style.backgroundImage="url("+l+")",s(r._modalContainerDiv),i._isLoading=!1,d["default"].isIE()&&(r._resizeEvent=e.addEventListener("resize",function(){setTimeout(function(){r._imageContainer.style.height=c.offsetHeight+"px"},0)})),r.options.registerPrevNextEvents?(r._setupPrevNextStates(),r._imageContainer.addEventListener(d["default"].getTabEvent(),function(t){if(!r.isLoading()){t.preventDefault();var n=t,i=e.TouchEvent&&n instanceof TouchEvent?n.changedTouches[0].pageX:n.pageX,o=r._imageContainer.getBoundingClientRect(),a=o.left,s=o.width,l=i-a;r.switchImageByDirection(s/2>l)["catch"](function(){r._runOptionalClose()})}}),r._keyboardNextEvent=function(e){if(e.keyCode===C||e.keyCode===T){if(r.isLoading())return;r.switchImageByDirection(e.keyCode===T)["catch"](function(){r._runOptionalClose()})}},e.addEventListener("keydown",r._keyboardNextEvent)):r._imageContainer.addEventListener(d["default"].getTabEvent(),function(){r._runOptionalClose()}),r.highRes(o,a)})}),i._future.then(function(){r._calculateContainer(i.img)}),r._modalContainerDiv.addEventListener(s.EVENT_MODAL_CLOSED,function(){i._modalContainerDiv.parentNode.removeChild(i._modalContainerDiv),i.options.onClose.apply(r),i._isOpen=!1,i.modal.destroy(),i._keyboardNextEvent&&e.removeEventListener("keydown",r._keyboardNextEvent),i._resizeEvent&&e.removeEventListener("resize",r._resizeEvent)}),i._future}),this._nextFuture=this._future,r._widget?(this.modal=new l["default"](this._modalAppend),this.modal.close().fromWidget(r._widget).then(function(){return r._future.then(function(){return r})})):!1)):!1}}],[{key:"_setupMaxWidthHeight",value:function(e,t,n){var i=e.getAttribute(h),r=e.getAttribute(v);i&&r?(t.style.maxWidth=i+"px",t.style.maxHeight=r+"px"):(t.style.maxWidth=n.width+"px",t.style.maxHeight=n.height+"px")}}]),t}();t["default"]=w}).call(t,function(){return this}())},function(e,t,n){(function(e){"use strict";function i(e){return e&&e.__esModule?e:{"default":e}}function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var o=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}();/*!
	 ...
	 * Copyright (c) 2015 David Heidrich, BowlingX <me@bowlingx.com>
	 */
Object.defineProperty(t,"__esModule",{value:!0}),t.EVENT_TOGGLE=void 0;var a=n(2),s=i(a),l=n(1),u=i(l),d=n(3),c=i(d),f="data-close-offcanvas",h="data-offcanvas",v="init",p="open",m=3,g=t.EVENT_TOGGLE="flexcss.offcanvas.toggle",y=function(){function t(n,i,o,a){var l=this;r(this,t);var d=e.document,c=0,f=n instanceof HTMLElement?n:d.getElementById(n),h=i instanceof HTMLElement?i:d.getElementById(i),v="toggle-"+h.id||"darkener",p=v+"-open",g=function(e){e.transform="",e.transition="",e.webkitTransform="",e.webkitTransition=""},y=function(){return window.innerWidth>=s["default"].get().smallBreakpoint};if(!h||!f)throw new Error("Could not find needed elements (Darkener and/or NavigationId)");this.darkener=h,this.darkenerClassToggle=v,this.darkenerClassToggleInstant=p,this.globalToggleClass=s["default"].get().canvasToggledClass,this.navigationContainer=f,this.navigationContainerId=f.id,this.navigationContainerId||(this.navigationContainerId=u["default"].guid(),f.id=this.navigationContainerId),a||(f.addEventListener("touchstart",function(e){requestAnimationFrame(function(){if(!y()){c=e.touches[0].clientX;var t=f,n=t.style;t.mustHide=!1,n.transition="transform 0s ease",n.webkitTransition="-webkit-transform 0s ease"}})}),f.addEventListener("touchmove",function(e){if(!y()){var t=e.touches[0].clientX,n=f,i=n.style,r=c-t,a=n.getBoundingClientRect(),s=o>0?0>=r:r>=0;if(s){n.mustHide=o>0?-1*r>a.width/m:r>a.width/m;var l="translate3d("+-1*r+"px,0,0)";i.transform=l,i.webkitTransform=l}}}),f.addEventListener("touchend",function(){requestAnimationFrame(function(){if(!y()){var e=f,t=e.style;if(e.mustHide){var n=e.getBoundingClientRect().width*o;t.transition="transform .2s ease",t.webkitTransition="-webkit-transform .2s ease";var i="translate3d("+n+"px,0,0)";t.transform=i,t.webkitTransform=i,l._remove(function(){g(t)}),l._removeInstant()}else g(t)}})}))}return o(t,[{key:"_remove",value:function(n){var i=this;u["default"].addEventOnce(s["default"].getTransitionEvent(),this.navigationContainer,function(){setTimeout(function(){requestAnimationFrame(function(){var r=e.document.body;t.currentOpen=null,r.classList.remove(i.darkenerClassToggle),e.document.documentElement.classList.remove(i.globalToggleClass),c["default"].dispatchAndFire(i.navigationContainer,g),n&&n()})},s["default"].get().darkenerFadeDelay)})}},{key:"_removeInstant",value:function(){this.navigationContainer.classList.remove(p),e.document.body.classList.remove(this.darkenerClassToggleInstant),this.darkener.classList.remove(v)}},{key:"_toggle",value:function(n){var i=this;n.preventDefault();var r=e.document.body.classList,o=this.darkener.classList,a=this.darkenerClassToggle,l=this.darkenerClassToggleInstant,d=this.navigationContainer.classList;this.navigationContainer.classList.contains(p)?(this._remove(),this._removeInstant(d)):t.currentOpen||(u["default"].addEventOnce(s["default"].getTransitionEvent(),this.navigationContainer,function(){c["default"].dispatchAndFire(i.navigationContainer,g)}),t.currentOpen=this,e.document.documentElement.classList.add(this.globalToggleClass),r.add(l),r.add(a),o.add(v),d.add(p))}},{key:"registerEvents",value:function(n){var i=this,r=n||e.document;r.addEventListener(s["default"].getTabEvent(),function(e){if(!t.currentOpen||t.currentOpen===i){var n=i.navigationContainerId,r=e.target.getAttribute(h)===n;u["default"].isPartOfNode(e.target,i.navigationContainer)?e.target.hasAttribute(f)&&i._toggle(e):(r||t.currentOpen===i&&e.target===i.darkener)&&i._toggle(e)}})}}]),t}();y.currentOpen=null,t["default"]=y}).call(t,function(){return this}())},function(e,t,n){(function(e){"use strict";function i(e){return e&&e.__esModule?e:{"default":e}}function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var o=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}();/*!
	 * FlexCss.Toggleable
	 * Licensed under the MIT License (MIT)
	 * Copyright (c) 2015 David Heidrich, BowlingX <me@bowlingx.com>
	 */

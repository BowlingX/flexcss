...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = to5Runtime.interopRequire(__webpack_require__(4));
	...
	var Form = (function () {
	  ...
	  to5Runtime.prototypeProperties(Form, {
	    serializeFormJSON: {
	    ...
	    _createArrayFromInvalidFieldList: {
	       ...
	       * @private
	       */
	      value: function CreateArrayFromInvalidFieldList(list) {
	        var arr = [];
	    ...
	    _formatErrorTooltip: {
	       ...
	       * @private
	       */
	      value: function FormatErrorTooltip(error) {
	    ...
	    _submitFunction: {
	       ...
	       * @returns {*}
	       */
	      value: function SubmitFunction(thisForm, e) {
	    ...
	    _setupErrorMessages: {
	      ...
	      value: function SetupErrorMessages(field, validity) {
	    ...
	    _removeElementErrors: {
	       ...
	       * @private
	       */
	      value: function RemoveElementErrors(thisParent) {
	    ...
	    _runValidation: {
	       ...
	       * @private
	       */
	      value: function RunValidation(validationRef, field) {
	        if (!this._validators[validationRef]) {
	          throw "Could not found validator: " + validationRef;
	        }
	        var cl = field.classList,
	            future = this._validators[validationRef].apply(this, [field, form]);
	    ...
	    _customValidationsForElements: {
	       ...
	       * @private
	       */
	      value: function CustomValidationsForElements(fields) {
	        var futures = [],
	            fieldsLength = fields.length,
	            checkedFields = [];
	        for (var iVal = 0; iVal < fieldsLength; iVal++) {
	          var field = fields[iVal],
	              validationRef = field.getAttribute("data-validate"),
	        ...
	        for (var i = 0; i < fields.length; i++) {
	          ...
	          if (validity && !validity.valid) {
	            ...
	            if (this.options.appendError) {
	              parent.insertAdjacentHTML("beforeend", "<div class=\"" + ERROR_CLASS_NAME + "\">" + field.validationMessage + "</div>");
	            }
	    ...
	    initFormValidation: {
	      ...
	      value: function initFormValidation() {
	         ...
	         * @returns {boolean}
	         */
	        var _checkIsValidBlurFocusElement = function (target) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CLASS_NAMES_BOTTOM = "arrow-bottom";
	...
	var Tooltip = (function () {
	  ...
	  to5Runtime.prototypeProperties(Tooltip, null, {
	    createTooltip: {
	      ...
	      value: function createTooltip(target, text, removeTitle) {
	        ...
	        var containerRect = tooltipContainer.getBoundingClientRect(),
	        ...
	        tooltipContainer.style.left = (targetRect.left + targetRect.width / 2 - containerRect.width / 2 || 0) - colRect.left + "px";
